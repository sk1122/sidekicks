...
export default function Home() {
  return (
    <div className="text-white flex w-full h-[80vh] flex-col items-center justify-center py-2 space-y-3">
      ...
      <div className='absolute right-10 md:right-20 xl:right-36'>
