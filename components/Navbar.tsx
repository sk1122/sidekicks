...
const Navbar = () => {
  ...
  return (
    <nav className="font-poppins flex w-full items-center justify-between bg-black px-16 py-6 text-white">
      <Link href="/">
        ...
        {accountData?.address && (
          <div className="space-y-5">
            ...
            <div
              ...
              className={
                (logoutModal ? '' : 'hidden ') +
                ' absolute z-50 flex w-40 items-center justify-center rounded-md bg-white p-3 text-black'
              }
            >
              Logout
            </div>
